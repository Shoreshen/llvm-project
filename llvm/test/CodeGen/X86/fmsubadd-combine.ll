...
; NOFMA-NEXT:    vaddpd %ymm4, %ymm0, %ymm3
...
; FMA3_256-NEXT:    vaddpd %ymm4, %ymm0, %ymm3
; FMA3_256-NEXT:    vsubpd %ymm4, %ymm0, %ymm0
...
; FMA3_256-NEXT:    vsubsd %xmm3, %xmm1, %xmm1
...
; FMA4-NEXT:    vaddpd %ymm4, %ymm0, %ymm3
...
; FMA4-NEXT:    vsubsd %xmm3, %xmm1, %xmm1
