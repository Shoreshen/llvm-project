...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1170-TRUE16-LABEL: v_maximumnum_v3f16:
; GFX1170-TRUE16:       ; %bb.0:
; GFX1170-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1170-TRUE16-NEXT:    v_pk_max_num_f16 v0, v0, v2
; GFX1170-TRUE16-NEXT:    v_max_num_f16_e32 v1.l, v1.l, v3.l
; GFX1170-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1170-FAKE16-LABEL: v_maximumnum_v3f16:
; GFX1170-FAKE16:       ; %bb.0:
; GFX1170-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1170-FAKE16-NEXT:    v_pk_max_num_f16 v0, v0, v2
; GFX1170-FAKE16-NEXT:    v_max_num_f16_e32 v1, v1, v3
; GFX1170-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-TRUE16-LABEL: v_maximumnum_v3f16:
; GFX12-TRUE16:       ; %bb.0:
; GFX12-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_expcnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_samplecnt 0x0
...
; GFX12-TRUE16-NEXT:    v_max_num_f16_e32 v1.l, v1.l, v3.l
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-FAKE16-LABEL: v_maximumnum_v3f16:
; GFX12-FAKE16:       ; %bb.0:
; GFX12-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-FAKE16-NEXT:    s_wait_expcnt 0x0
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0
...
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1251-TRUE16-LABEL: v_maximumnum_v3f16:
; GFX1251-TRUE16:       ; %bb.0:
; GFX1251-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1251-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1251-TRUE16-NEXT:    v_pk_max_num_f16 v0, v0, v2
; GFX1251-TRUE16-NEXT:    v_max_num_f16_e32 v1.l, v1.l, v3.l
; GFX1251-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1251-FAKE16-LABEL: v_maximumnum_v3f16:
; GFX1251-FAKE16:       ; %bb.0:
; GFX1251-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1251-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1251-FAKE16-NEXT:    v_pk_max_num_f16 v0, v0, v2
; GFX1251-FAKE16-NEXT:    v_max_num_f16_e32 v1, v1, v3
; GFX1251-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1251-NEXT:    v_pk_maximum3_f16 v1, v1, v3, v3
; GFX1251-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1251-LABEL: v_maximumnum_v2f16_no_ieee:
; GFX1251:       ; %bb.0:
; GFX1251-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1251-NEXT:    s_wait_kmcnt 0x0
; GFX1251-NEXT:    v_pk_max_num_f16 v0, v0, v1
