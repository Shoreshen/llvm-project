...
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX11,GISEL,GISEL-GFX11,GISEL-GFX11-TRUE16 %s
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX11,GISEL,GISEL-GFX11,GISEL-GFX11-FAKE16 %s
...
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1170 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX1170,GISEL,GISEL-GFX1170,GISEL-GFX1170-TRUE16 %s
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1170 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX1170,GISEL,GISEL-GFX1170,GISEL-GFX1170-FAKE16 %s
...
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX12,GISEL,GISEL-GFX12,GISEL-GFX12-TRUE16 %s
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1200 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX12,GISEL,GISEL-GFX12,GISEL-GFX12-FAKE16 %s
...
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1250 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX1250,GISEL,GISEL-GFX1250,GISEL-GFX1250-TRUE16 %s
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1250 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX1250,GISEL,GISEL-GFX1250,GISEL-GFX1250-FAKE16 %s
...
; SDAG-GFX11-LABEL: s_test_minmax_i32:
; SDAG-GFX11:       ; %bb.0:
; SDAG-GFX11-NEXT:    s_max_i32 s0, s0, s1
; SDAG-GFX11-NEXT:    s_mov_b32 s5, s4
; SDAG-GFX11-NEXT:    s_min_i32 s0, s0, s2
...
;
; GISEL-GFX11-LABEL: s_test_minmax_i32:
; GISEL-GFX11:       ; %bb.0:
; GISEL-GFX11-NEXT:    s_max_i32 s0, s0, s1
; GISEL-GFX11-NEXT:    s_mov_b32 s6, s3
; GISEL-GFX11-NEXT:    s_min_i32 s0, s0, s2
; GISEL-GFX11-NEXT:    s_mov_b32 s7, s4
; GISEL-GFX11-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, 0
...
; SDAG-GFX12-NEXT:    s_min_i32 s0, s0, s2
; SDAG-GFX12-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s0
; SDAG-GFX12-NEXT:    s_mov_b32 s4, s3
; SDAG-GFX12-NEXT:    global_store_b32 v0, v1, s[4:5]
; SDAG-GFX12-NEXT:    s_endpgm
;
; GISEL-GFX12-LABEL: s_test_minmax_i32:
; GISEL-GFX12:       ; %bb.0:
; GISEL-GFX12-NEXT:    s_max_i32 s0, s0, s1
; GISEL-GFX12-NEXT:    s_mov_b32 s6, s3
; GISEL-GFX12-NEXT:    s_min_i32 s0, s0, s2
; GISEL-GFX12-NEXT:    s_mov_b32 s7, s4
; GISEL-GFX12-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, 0
; GISEL-GFX12-NEXT:    global_store_b32 v1, v0, s[6:7]
; GISEL-GFX12-NEXT:    s_endpgm
;
; SDAG-GFX1250-LABEL: s_test_minmax_i32:
; SDAG-GFX1250:       ; %bb.0:
; SDAG-GFX1250-NEXT:    global_wb
...
; SDAG-GFX1250-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s0
; SDAG-GFX1250-NEXT:    s_mov_b32 s4, s3
; SDAG-GFX1250-NEXT:    global_store_b32 v0, v1, s[4:5]
; SDAG-GFX1250-NEXT:    s_endpgm
;
; GISEL-GFX1250-LABEL: s_test_minmax_i32:
; GISEL-GFX1250:       ; %bb.0:
; GISEL-GFX1250-NEXT:    global_wb
...
; SDAG-GFX11-LABEL: s_test_minmax_u32:
; SDAG-GFX11:       ; %bb.0:
; SDAG-GFX11-NEXT:    s_max_u32 s0, s0, s1
; SDAG-GFX11-NEXT:    s_mov_b32 s5, s4
; SDAG-GFX11-NEXT:    s_min_u32 s0, s0, s2
; SDAG-GFX11-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s0
; SDAG-GFX11-NEXT:    s_mov_b32 s4, s3
; SDAG-GFX11-NEXT:    global_store_b32 v0, v1, s[4:5]
; SDAG-GFX11-NEXT:    s_endpgm
;
; GISEL-GFX11-LABEL: s_test_minmax_u32:
; GISEL-GFX11:       ; %bb.0:
; GISEL-GFX11-NEXT:    s_max_u32 s0, s0, s1
; GISEL-GFX11-NEXT:    s_mov_b32 s6, s3
; GISEL-GFX11-NEXT:    s_min_u32 s0, s0, s2
; GISEL-GFX11-NEXT:    s_mov_b32 s7, s4
; GISEL-GFX11-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, 0
; GISEL-GFX11-NEXT:    global_store_b32 v1, v0, s[6:7]
; GISEL-GFX11-NEXT:    s_endpgm
...
; SDAG-GFX12-NEXT:    s_mov_b32 s5, s4
; SDAG-GFX12-NEXT:    s_min_u32 s0, s0, s2
; SDAG-GFX12-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s0
; SDAG-GFX12-NEXT:    s_mov_b32 s4, s3
; SDAG-GFX12-NEXT:    global_store_b32 v0, v1, s[4:5]
; SDAG-GFX12-NEXT:    s_endpgm
;
; GISEL-GFX12-LABEL: s_test_minmax_u32:
; GISEL-GFX12:       ; %bb.0:
; GISEL-GFX12-NEXT:    s_max_u32 s0, s0, s1
; GISEL-GFX12-NEXT:    s_mov_b32 s6, s3
; GISEL-GFX12-NEXT:    s_min_u32 s0, s0, s2
; GISEL-GFX12-NEXT:    s_mov_b32 s7, s4
; GISEL-GFX12-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, 0
; GISEL-GFX12-NEXT:    global_store_b32 v1, v0, s[6:7]
; GISEL-GFX12-NEXT:    s_endpgm
...
; SDAG-GFX1250-TRUE16-NEXT:    global_wb
...
; SDAG-GFX1250-FAKE16-NEXT:    global_wb
